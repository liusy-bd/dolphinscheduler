...
public class SeatunnelTaskTest {
    ...
    public void formatDetector() throws Exception{
        SeatunnelDefineParameters seatunnelParameters = new SeatunnelDefineParameters();
        ...
        SeatunnelDefineTask seatunnelTask = new SeatunnelDefineTask(taskExecutionContext);
